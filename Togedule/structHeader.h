...
int InputSubjectNum(int* SubjectNumOfoneday, int* subjectTotalNum, structMember *s); // 시간표만들기 - 월~금 과목갯수 입력 함수
...
void friendSaveCost(structPromise *loginpl,int listnumber,char *fileName,int *arrMoney,int friendnum);  //비용저장
